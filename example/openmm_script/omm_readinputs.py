...
Modified for BBS simulation & COMReporter (omm_comreporter.py)
Correspondance: sop316@lehigh.edu or wonpil@lehigh.edu
Lasts update: Nov 25, 2023.
"""
...
class _OpenMMReadInputs():
    ...
    def __init__(self):
        ...
        # COMReporter - begin
        self.nstcom           = 0                                         # Writing COM trajectory frequency (steps)
        # COMReporter - end
        ...
        # BBS - begin
        # V(X) 
        self.fc_wall          = 0.0                                       # force constant for lipid separation (kJ/mol/nm^2)
        self.margin           = 0.0                                       # XM: half width of mixing zone (nm)
        self.wall_xref        = 0.0                                       # Xref for V(X)
        # U(X) = fc_com * (X - XCOM)^2
        self.fc_com        = 0.0                                          # force constant for X-COM (kJ/mol/nm^2)
        self.com           = 0.0                                          # X-COM of the embedded MP
        # BBS - end
